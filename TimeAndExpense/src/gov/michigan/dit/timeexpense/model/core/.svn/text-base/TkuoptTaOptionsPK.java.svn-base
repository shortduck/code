 ...
 */
@Embeddable
public class TkuoptTaOptionsPK implements Serializable {
    
	private static final long serialVersionUID = -6214863297793892559L;
    ...
    public TkuoptTaOptionsPK() {
    }

    public TkuoptTaOptionsPK(String department, String agency, String tku) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof TkuoptTaOptionsPK)) {
            return false;
        }
        TkuoptTaOptionsPK other = (TkuoptTaOptionsPK) object;
    ...
    public String toString() {
        return "gov.michigan.dit.timeexpense.model.TkuoptTaOptionsPK[department=" + department + ", agency=" + agency + ", tku=" + tku + "]";
    }
